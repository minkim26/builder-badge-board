// Keep this in sync with tampermonkey/progress-sync.user.js — this copy
// backs the "Copy script" button in the admin setup instructions, so the
// whole one-time setup flow lives on one page instead of the repo.
export const TAMPERMONKEY_SCRIPT = `// ==UserScript==
